...
/**
 * Test rehydration of Map of entities.
 */
class MapEntityIT extends IntegrationTest {
    @Test
    public void testPostMapEntity() {

        Map<String, MapEntry> entries = new HashMap<>();
        MapEntry mapEntry = new MapEntry();
        mapEntry.setId(1);
        mapEntry.setMapEntityId(1);
        mapEntry.setName("hello");
        entries.put(mapEntry.getName(), mapEntry);
